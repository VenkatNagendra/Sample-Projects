...
import numpy as np
import math
import Main_image as Main
import random
import matplotlib.pyplot as plt
import Preprocess
import DetectChars
from PIL import Image
import Plate as PossiblePlate
import Char as PossibleChar
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       
        ...
        possibleChar = PossibleChar.Char(contours[i])
...
def extractPlate(imgOriginal, listOfMatchingChars):
    possiblePlate = PossiblePlate.Plate()
